...
def build_model(
    ...
    model = tf.keras.Model(inputs, outputs, name="ecodetect_mobilenetv3")
...
def main() -> None:
    ...
    model_path = args.output_dir / "ecodetect_mobilenetv3.keras"
    ...
    (args.output_dir / "ecodetect_mobilenetv3.tflite").write_bytes(tflite_model)
